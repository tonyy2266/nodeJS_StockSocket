...
var io = config.isHttp ? require('socket.io').listen(http, { pingInterval: config.pingInterval, pingTimeout: config.pingTimeout, path: '/stockSocketUAT' }) :
  require('socket.io').listen(httpsSocket, { pingInterval: config.pingInterval, pingTimeout: config.pingTimeout, path: '/stockSocketUAT' })
